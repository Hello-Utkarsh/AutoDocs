...
const SideBar = () => {
  ...
  return (
    <div className='flex w-full'>
      <div className='transition-all w-[18%] px-2 py-6 bg-[#EFEDE7] h-screen text-left flex flex-col border-r border-gray-400 relative overflow-hidden' style={{ marginLeft: sidebarToggle ? "0%" : "-13%" }}>
        <button className='cursor-pointer absolute right-3 top-7' onClick={() => setToggle(!sidebarToggle)}>toggel</button>
        <h1 className='text-3xl font-semibold text-start ml-3 leading-7 text-black'>AutoDocs</h1>
